...
public class AppRater {
    private final static String APP_TITLE = "Hrithik Roshan HD Wallpapers";// App Name
    private final static String APP_PNAME = "geeksforgeekssoftwares.hrithikroshan.wallpapers";// Package Name
